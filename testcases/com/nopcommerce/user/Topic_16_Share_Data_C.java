...
public class Topic_16_Share_Data_C extends BaseTest {
...
@BeforeClass
	...
	//add cookies vaò form đăng nhập
	//Dùng vòng lặp để duyệt cookie
	
	//	Set<Cookie> cookies = Common_01_Register_Cookies.loggedCookies;
